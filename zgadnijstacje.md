---
layout: default
title: zgadnijstacje.pl
---

{% include back_to_home.html %}

<div style="text-align: center; margin: 20px 0;">
  <img src="assets/images/projects/zgadnijstacje/logo.png" alt="Metro Warszawskie Logo" style="max-width: 300px; height: auto;">
</div>

<div style="text-align: center; margin: 20px 0;">
  <h1>Metro Warszawskie</h1>
  <p style="font-size: 1.1em; color: #555;">A Warsaw Metro Station Guessing Game</p>
</div>
...
<div style="text-align: center; margin: 30px 0;">
  ...
  <img src="assets/images/projects/zgadnijstacje/screenshot.png" alt="Metro Warszawskie Gameplay" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
  <p style="font-size: 0.9em; color: #7f8c8d; margin-top: 10px;">Interactive map-based station guessing gameplay</p>
</div>

<div style="text-align: center; margin: 30px 0;">
  <h3>Engagement & Celebration</h3>
  <img src="assets/images/projects/zgadnijstacje/engagement-24h.png" alt="Victory Celebration" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
  <p style="font-size: 0.9em; color: #7f8c8d; margin-top: 10px;">Confetti celebration and score sharing on game completion</p>
</div>
    ...
    <div class="experience-header">
      <div class="company-info">
        <div class="company-details">
          ...
          <p style="margin: 5px 0 0 0; font-size: 0.9em; color: #7f8c8d; font-style: italic;">Real-time visualization of discovered stations on an OpenStreetMap-based interface</p>
        </div>
      </div>
    </div>
    
    <div class="experience-content">
      <p>Real-time visualization of discovered stations on an OpenStreetMap-based interface powered by Leaflet.</p>
      
      <div class="highlights">
        <div class="highlight-item">
          <p class="highlight-description">• Visual feedback as you discover each station</p>
          <p class="highlight-description">• See station locations on an accurate Warsaw metro map</p>
          <p class="highlight-description">• Track progress across M1 and M2 lines</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="experience-header">
      <div class="company-info">
        <div class="company-details">
          ...
          <p style="margin: 5px 0 0 0; font-size: 0.9em; color: #7f8c8d; font-style: italic;">Intelligent input matching that handles typos and Polish diacritical marks</p>
        </div>
      </div>
    </div>
    
    <div class="experience-content">
      <p>Intelligent input matching that handles typos and Polish diacritical marks, making the game forgiving and accessible.</p>
      
      <div class="highlights">
        <div class="highlight-item">
          <p class="highlight-description">• Type "Swietokrzyska" and match "Świętokrzyska"</p>
          <p class="highlight-description">• Handles common typos and variations</p>
          <p class="highlight-description">• Normalizes Polish characters automatically</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="experience-header">
      <div class="company-info">
        <div class="company-details">
          ...
          <p style="margin: 5px 0 0 0; font-size: 0.9em; color: #7f8c8d; font-style: italic;">Full Polish and English interface for international accessibility</p>
        </div>
      </div>
    </div>
    
    <div class="experience-content">
      <p>Full Polish and English interface for international accessibility.</p>
      
      <div class="highlights">
        <div class="highlight-item">
          <p class="highlight-description">• Switch between Polish and English seamlessly</p>
          <p class="highlight-description">• Supports both language inputs for station names</p>
          <p class="highlight-description">• Accessible to locals and international visitors</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="experience-header">
      <div class="company-info">
        <div class="company-details">
          ...
          <p style="margin: 5px 0 0 0; font-size: 0.9em; color: #7f8c8d; font-style: italic;">Score decreases over time, rewarding quick and accurate guessing</p>
        </div>
      </div>
    </div>
    
    <div class="experience-content">
      <p>Score decreases over time, rewarding quick and accurate guessing.</p>
      
      <div class="highlights">
        <div class="highlight-item">
          <p class="highlight-description">• Compete for the fastest completion times</p>
          <p class="highlight-description">• Real-time score updates</p>
          <p class="highlight-description">• Encourages speed and accuracy</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="experience-header">
      <div class="company-info">
        <div class="company-details">
          ...
          <p style="margin: 5px 0 0 0; font-size: 0.9em; color: #7f8c8d; font-style: italic;">Share your victory with confetti animations and social media integration</p>
        </div>
      </div>
    </div>
    
    <div class="experience-content">
      <p>Share your victory with confetti animations and social media integration.</p>
      
      <div class="highlights">
        <div class="highlight-item">
          <p class="highlight-description">• Confetti celebration on game completion</p>
          <p class="highlight-description">• Share results on Twitter/X and Facebook</p>
          <p class="highlight-description">• Challenge friends to beat your score</p>
        </div>
      </div>
    </div>
  </div>
